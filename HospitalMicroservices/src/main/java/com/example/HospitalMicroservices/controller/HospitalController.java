...
public class HospitalController {
    ...
    public ResponseEntity<HospitalProxy> registerHospital(@RequestBody HospitalProxy hospitalProxy){

        return ResponseEntity.ok(hospitalService.registerHospital(hospitalProxy));
    }
